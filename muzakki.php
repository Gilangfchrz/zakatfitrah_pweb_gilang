...
$stmt = $con->prepare('SELECT id_muzakki, nama_muzakki, jumlah_tanggungan, keterangan FROM muzakki WHERE id = ?');
// In this case we can use the account ID to get the account info.
$stmt->bind_param('i', $_SESSION['id']);
$stmt->execute();
$stmt->bind_result( $id_muzakki,$nama_muzakki, $jumlah_tanggungan, $keterangan);
$stmt->fetch();
$stmt->close();
?>
